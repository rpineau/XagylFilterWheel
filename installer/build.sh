...
pkgbuild --root ROOT --identifier org.rti-zone.XagylFilterWheel_X2 --sign "$installer_signature" --scripts Scripts --version 1.0 XagylFilterWheel_X2.pkg
pkgutil --check-signature ./XagylFilterWheel_X2.pkg
else
pkgbuild --root ROOT --identifier org.rti-zone.XagylFilterWheel_X2 --scripts Scripts --version 1.0 XagylFilterWheel_X2.pkg
fi
