...
PACKAGE_NAME="XagylFilterWheel_X2.pkg"
BUNDLE_NAME="org.rti-zone.XagylFilterWheelX2"

if [ ! -z "$app_id_signature" ]; then
    codesign -f -s "$app_id_signature" --verbose ../build/Release/libXagylFilterWheel.dylib
fi
